            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      buildPetFeature("4 Kg", "Weight"),
                      buildPetFeature("Cold", "Best Climate")
                ...
                Padding(
                  padding: EdgeInsets.symmetric(horizontal: 16),
                  child: Text(
                    "Long-haired and lovable, the Bearded Collie is one of the most popular herding breeds in the world. They are primarily kept as pets in the modern world.",
                    style: TextStyle(
                      color: Colors.grey[600],
                      fontSize: 14,
                    ),
